...
${OBJECTDIR}/view/WidgetProduction.o: view/WidgetProduction.cc 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/WidgetProduction.o view/WidgetProduction.cc

${OBJECTDIR}/view/WidgetSales.o: view/WidgetSales.cc 
	${MKDIR} -p ${OBJECTDIR}/view
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/view/WidgetSales.o view/WidgetSales.cc
